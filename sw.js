...
const V='nika-v1';
const CORE=['/','/index.html','/docs.html','/changelog.html','/404.html','/style.css?v=27','/manifest.json','/assets/qr.js','/assets/logo-512.webp?v=2','/assets/logo-hero.webp?v=2','/assets/favicon.png?v=2','/assets/paper.webp',
