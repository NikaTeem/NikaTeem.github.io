...
const V='nika-v10';
const CORE=['/','/index.html','/docs.html','/changelog.html','/brand.html','/trust.html','/404.html','/style.css?v=36','/manifest.json','/assets/qr.js','/assets/logo-512.webp?v=2','/assets/logo-hero.webp?v=2','/assets/favicon.png?v=2','/assets/paper.webp',
